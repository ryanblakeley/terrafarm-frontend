...
- [ ] voucher and share edit, save with immediate update
- [ ] get rid of credits_remaining
- [ ] update changelog and tag v2.0.1

### 2.0.2

- [ ] big time cleanup for all the above new stuff
  - 'distribution' is a lot of letters to put in a url, maybe change db to 'voucher'
