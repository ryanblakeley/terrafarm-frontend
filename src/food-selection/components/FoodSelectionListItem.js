...
const propTypes = {
  ...
  measureWeightAmount: PropTypes.string,
  measureWeightUnit: PropTypes.string,
  measureVolumeAmount: PropTypes.string,
  measureVolumeUnit: PropTypes.string,
  measureCommonAmount: PropTypes.string,
...
const defaultProps = {
  mass: '',
  nutrition: {},
  measureWeightAmount: null,
  measureWeightUnit: '',
  measureVolumeAmount: null,
  measureVolumeUnit: '',
  measureCommonAmount: null,
  measureCommonUnit: '',
  unitDescription: '',
  url: '',
  editing: false,
